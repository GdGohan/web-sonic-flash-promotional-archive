...
if (!s_account) {
    var s_account="segaglobal,segaus";
}
...
s.linkInternalFilters="javascript:,stage.sega.co.uk,stage.sega.fr,stage.sega.es,stage.sega.de,stage.sega.com,stage.sega-australia.com,www.sega.co.uk,www.sega.fr,www.sega.es,www.sega.de,www.sega.com,www.sega-australia.com"
...
function s_doPlugins(s) {
  ...
  s.prop17=s.eVar17=s.getTimeParting('h','-5',year); // Set hour
  s.prop18=s.eVar18=s.getTimeParting('d','-5',year); // Set day
  s.prop19=s.eVar19=s.getTimeParting('w','-5',year); // Set Weekend / Weekday

  /* External Campaign Tracking */
  if(!s.campaign)	s.campaign=s.getQueryParam('cid');//Set campaign here if not set in page already.
  ...
  *********************/
  ...
  if(s.prop15&&!s.eVar11) s.eVar11=s.prop15;
